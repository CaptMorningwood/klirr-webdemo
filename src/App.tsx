...
Obs: AI-endpointen kunde inte nås, så detta är lokalt fallback-svar.` }] });
  ...
  return <Card className="chat-shell">
    <div className="chat-header"><h2 style={{ margin: 0 }}>Budget Buddy ✨</h2><p style={{ margin: '5px 0 0', color: 'var(--muted)' }}>Din Budgetska rådgivar-kompis i Klirr. Ändringar visas alltid tydligt och kräver ditt ja.</p></div>
